...
export default function PrivacyPolicy() {
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <section className="privacy-policy space-y-4 max-w-4xl mx-auto py-20">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Invoicer.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Invoicer, accessible from{" "}
              <a
                href="https://invoicerv2.vercel.app"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://invoicerv2.vercel.app
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>
              ...
              <a
                href="https://invoicerv2.vercel.app/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://invoicerv2.vercel.app/contact
              </a>
            </p>
          </li>
        </ul>
